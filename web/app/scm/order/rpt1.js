...
var model = avalon.define({$id:'view',user:SYSTEM.user,
    query :{start_date:SYSTEM.beginDate,type:type,end_date:SYSTEM.endDate,f:f,m:"",t:0,tax:"",customer_id:'',customer_name:'',product_billsn:'',product_id:'',product_name:'',head_id:"",head_name:""},
	...
	init:function(){
		...
		$(".fa-refresh").click(function(){
			model.query ={start_date:SYSTEM.beginDate,type:type,end_date:SYSTEM.endDate,f:f,m:"",t:0,tax:"",customer_id:'',customer_name:'',product_billsn:'',product_id:'',product_name:'',head_id:"",head_name:""}
			//model.loadData();
		})
//		model.loadData();
		model.initBsSuggest();
