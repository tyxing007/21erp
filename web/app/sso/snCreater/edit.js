...
$_form=$("#base_form"),addNew=false,companyList = SYSTEM.companyList;
var model = avalon.define({
	$id:'ctrl',
	data:{id:"",name:'',code:"",qz:"",qyrq:0,rqgs:"",dqxh:1,sfmrgx:0,udate:"",ws:4,companyId:""},
	...
	init:function(){
		model.data={id:"",name:'',code:"",qz:"",qyrq:0,rqgs:"",dqxh:1,sfmrgx:0,udate:"",ws:4,companyId:""};
	},
...
var THISPAGE = {
	...
	initDom : function() {
		if(id!=undefined&&id!=''&&id!='undefined'){
			Public.ajaxPost(rootPath+"/sso/snCreater/qryOp.json",{id:id,companyId:api.data.companyId}, function(json){
				if(json.status==200){
