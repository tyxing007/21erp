...
var model = avalon.define({$id:'ctrl',
	data:{id:"",position_id:"",position_name:"",uname:"",password:"",realname:"",sex:0,status:1,email:'',mobile:'',telephone:'',remark:'',address:'',companyId:companyId},
...
var THISPAGE = {
	...
	reset:function(){
		model.data = {id:"",position_id:"",position_name:"",uname:"",password:"",realname:"",sex:0,status:1,email:'',mobile:'',telephone:'',remark:'',address:'',companyId:companyId};
	},
	initDom:function() {
		if(id!=undefined&&id!=''&&id!='undefined'){
			Public.ajaxPost(rootPath+"/sso/user/qryOp.json",{id:id,companyId:companyId}, function(json){
				if(json.status==200){
		...
		$("#position").click(function(){
			...
			var r=$("#position");
			var i=Public.comboTree(r,{url:rootPath+'/sso/position/tree.json',postData:{companyId:companyId},callback:{
