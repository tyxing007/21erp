!function ($) {
    ...
    $.jgrid = $.jgrid || {};
    $.extend($.jgrid, {
        version: "4.6.0", htmlDecode: function (e) {
            ...
            var e = -1, t = navigator.userAgent, i = new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");
            ...
            var a, s, o, n = /\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g, l = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, d = /[^-+\dA-Z]/g, c = new RegExp("^/Date\\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\\)/$"), u = "string" == typeof t ? t.match(c) : null, p = function (e, t) {
                e = String(e);
                t = parseInt(t, 10) || 2;
                for (; e.length < t;)e = "0" + e;
                return e
            }, h = {m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0}, f = 0, g = function (e, t) {
            ...
            if (t && null != t)if (isNaN(t - 0) || "u" !== String(e).toLowerCase())if (t.constructor === Date)f = t; else if (null !== u) {
            ...
            } else f = new Date(1e3 * parseFloat(t)); else f = new Date(h.y, h.m, h.d, h.h, h.i, h.s, h.u);
            if (void 0 === i)return f;
            r.masks.hasOwnProperty(i) ? i = r.masks[i] : i || (i = "Y-m-d");
            var b = f.getHours(), w = f.getMinutes(), y = f.getDate(), C = f.getMonth() + 1, N = f.getTimezoneOffset(), D = f.getSeconds(), k = f.getMilliseconds(), _ = f.getDay(), j = f.getFullYear(), x = (_ + 6) % 7 + 1, I = (new Date(j, C - 1, y) - new Date(j, 0, 1)) / 864e5, T = {
                d: p(y),
                D: r.dayNames[_],
                j: y,
                l: r.dayNames[_ + 7],
                ...
                w: _,
                z: I,
                W: 5 > x ? Math.floor((I + x - 1) / 7) + 1 : Math.floor((I + x - 1) / 7) || ((new Date(j - 1, 0, 1).getDay() + 6) % 7 < 4 ? 53 : 52),
            ...
            var e = $("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"), t = e.appendTo("body").find("td").width();
            e.remove();
            ...
            var QueryObject = function (d, q) {
                ...
                this._doSort = function (e, t) {
                    var i = _sorting[t].by, r = _sorting[t].dir, a = _sorting[t].type, s = _sorting[t].datefmt, o = _sorting[t].sfunc;
                    if (t === _sorting.length - 1)return self._getOrder(e, i, r, a, s, o);
                    t++;
                    var n, l, d, c = self._getGroup(e, i, r, a, s), u = [];
                    for (n = 0; n < c.length; n++) {
                        d = self._doSort(c[n].items, t);
                        for (l = 0; l < d.length; l++)u.push(d[l])
                    }
                    return u
                };
                this._getOrder = function (e, t, i, r, a, s) {
                    var o, n, l, d, c = [], u = [], p = "a" === i ? 1 : -1;
                    void 0 === r && (r = "text");
                ...
                this._compareValues = function (e, t, i, r, a) {
                    ...
                    void 0 === i && (i = null);
                    var o = i, n = void 0 === a.stype ? "text" : a.stype;
                    if (null !== i)switch (n) {
                        case"int":
                        case"integer":
                        ...
                        case"date":
                        case"datetime":
                            o = String($.jgrid.parseDate(a.newfmt || "Y-m-d", o).getTime());
                ...
                this.startsWith = function (e, t) {
                    ...
                    if (_useProperties)self._append(self._getStr("jQuery.jgrid.getAccessor(this,'" + e + "')") + ".substr(0," + r + ") == " + self._getStr('"' + self._toStr(t) + '"')); else {
        ...
        return this.each(function () {
            if (!this.grid) {
                var t = $.extend(!0, {
                    ...
                    multiSort: !1,
                    minColWidth: 33
                }, $.jgrid.defaults, e || {}), i = this, r = {
                    headers: [],
                    cols: [],
                    footers: [],
                    dragStart: function (e, r, a) {
                        var s = $(this.bDiv).offset().left;
                        this.resizing = {idx: e, startX: r.pageX, sOL: r.pageX - s};
                        this.hDiv.style.cursor = "col-resize";
                        this.curGbox = $("#rs_m" + $.jgrid.jqID(t.id), "#gbox_" + $.jgrid.jqID(t.id));
                        this.curGbox.css({display: "block", left: r.pageX - s, top: a[1], height: a[2]});
                    ...
                    dragMove: function (e) {
                        if (this.resizing) {
                            var i, r, a = e.pageX - this.resizing.startX, s = this.headers[this.resizing.idx], o = "ltr" === t.direction ? s.width + a : s.width - a;
                            if (o > 33) {
                    ...
                    dragEnd: function () {
                        ...
                        if (this.resizing) {
                            var e = this.resizing.idx, r = this.headers[e].newWidth || this.headers[e].width;
                            r = parseInt(r, 10);
                            this.resizing = !1;
                    ...
                    populateVisible: function () {
                        ...
                        if (e) {
                            ...
                            if (a) {
                                r.prevRowHeight = a;
                                var n, l, d, c = t.rowNum, u = r.scrollTop = r.bDiv.scrollTop, p = Math.round(s.position().top) - u, h = p + s.height(), f = a * c;
                                if (e > h && 0 >= p && (void 0 === t.lastpage || (parseInt((h + u + f - 1) / f, 10) || 0) <= t.lastpage)) {
                                    l = parseInt((e - h + f - 1) / f, 10) || 1;
                                    if (h >= 0 || 2 > l || t.scroll === !0) {
                                        n = (Math.round((h + u) / f) || 0) + 1;
                                        p = -1
                                    } else p = 1
                                }
                                if (p > 0) {
                                    n = (parseInt(u / f, 10) || 0) + 1;
                                    l = (parseInt((u + e) / f, 10) || 0) + 2 - n;
                                    d = !0
                                }
                                if (l) {
                                    if (t.lastpage && (n > t.lastpage || 1 === t.lastpage || n === t.page && n === t.lastpage))return;
                                    if (r.hDiv.loading)r.timer = setTimeout(r.populateVisible, t.scrollTimeout); else {
                                        t.page = n;
                                        if (d) {
                    ...
                    selectionPreserver: function (e) {
                        var t = e.p, i = t.selrow, r = t.selarrrow ? $.makeArray(t.selarrrow) : null, a = e.grid.bDiv.scrollLeft, s = function () {
                            var o;
                            t.selrow = null;
                            t.selarrrow = [];
                            if (t.multiselect && r && r.length > 0)for (o = 0; o < r.length; o++)r[o] !== i && $(e).jqGrid("setSelection", r[o], !1, null);
                ...
                if ("TABLE" === this.tagName.toUpperCase() && null != this.id)if (void 0 !== document.documentMode && document.documentMode <= 5)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length === this.p.colModel.length) {
                        var o = $("<div class='ui-jqgrid-view'></div>"), n = $.jgrid.msie;
                        ...
                        $(l).attr({id: "gbox_" + this.id, dir: s}).insertBefore(o);
                        $(o).attr("id", "gview_" + this.id).appendTo(l);
                        ...
                        var d = ["shiftKey", "altKey", "ctrlKey"], c = function (e, t) {
                            e = parseInt(e, 10);
                            return isNaN(e) ? t || 0 : e
                        }, u = function (e, t, a, s, o, n) {
                            var l, d = i.p.colModel[e], c = d.align, u = 'style="', p = d.classes, h = d.name, f = [];
                            c && (u += "text-align:" + c + ";");
                            d.hidden === !0 && (u += "display:none;");
                            if (0 === t)u += "width: " + r.headers[e].width + "px;"; else if (d.cellattr && $.isFunction(d.cellattr)) {
                                l = d.cellattr.call(i, o, a, s, d, n);
                            ...
                            var o, n = i.p.colModel[r];
                            if (void 0 !== n.formatter) {
                                e = "" !== String(i.p.idPrefix) ? $.jgrid.stripPref(i.p.idPrefix, e) : e;
                                var l = {rowId: e, colModel: n, gid: i.p.id, pos: r};
                                o = $.isFunction(n.formatter) ? n.formatter.call(i, t, l, a, s) : $.fmatter ? $.fn.fmatter.call(i, n.formatter, t, l, a, s) : p(t)
                            } else o = p(t);
                            return o
                            ...
                            o = h(e, t, i, a, "add");
                            n = u(i, r, o, a, e, s);
                            return '<td role="gridcell" ' + n + ">" + o + "</td>"
                        }, g = function (e, t, r, a) {
                            var s = '<input role="checkbox" type="checkbox" id="jqg_' + i.p.id + "_" + e + '" class="cbox" name="jqg_' + i.p.id + "_" + e + '"' + (a ? 'checked="checked"' : "") + "/>", o = u(t, r, "", null, e, !0);
                            return '<td role="gridcell" ' + o + ">" + s + "</td>"
                        }, m = function (e, t, i, r) {
                            var a = (parseInt(i, 10) - 1) * parseInt(r, 10) + 1 + t, s = u(e, t, a, null, t, !0);
                            ...
                            e = i.p.keyName === !1 || i.p.loadonce === !0 ? i.p.localReader.id : i.p.keyName;
                            for (t = 0; a > t; t++) {
                                r = $.jgrid.getAccessor(i.p.data[t], e);
                                void 0 === r && (r = String(t + 1));
                                i.p._index[r] = t
                            }
                        }, C = function (e, t, r, a, s, o) {
                            var n, l = "-1", d = "", c = t ? "display:none;" : "", u = "ui-widget-content jqgrow ui-row-" + i.p.direction + (r ? " " + r : "") + (o ? " ui-state-highlight" : ""), p = $(i).triggerHandler("jqGridRowAttr", [a, s, e]);
                            ...
                            if (!$.isEmptyObject(p)) {
                                ...
                                for (n in p)p.hasOwnProperty(n) && (d += " " + n + "=" + p[n])
                            }
                            return '<tr role="row" id="' + e + '" tabindex="' + l + '" class="' + u + '"' + ("" === c ? "" : ' style="' + c + '"') + d + ">"
                        }, N = function (e, t, r, a, s) {
                            var o = new Date, n = "local" !== i.p.datatype && i.p.loadonce || "xmlstring" === i.p.datatype, l = "_id_", d = i.p.xmlReader, u = "local" === i.p.datatype ? "local" : "xml";
                            if (n) {
                                i.p.data = [];
                                i.p._index = {};
                            ...
                            i.p.reccount = 0;
                            if ($.isXMLDoc(e)) {
                                if (-1 !== i.p.treeANode || i.p.scroll)r = r > 1 ? r : 1; else {
                                    w.call(i, !1, !0);
                                    r = 1
                                }
                                var p, h, y, N, D, k, _, j, x, I, T = $(i), S = 0, E = i.p.multiselect === !0 ? 1 : 0, F = 0, R = i.p.rownumbers === !0 ? 1 : 0, q = [], P = {}, A = [], M = i.p.altRows === !0 ? i.p.altclass : "";
                                if (i.p.subGrid === !0) {
                                    F = 1;
                                ...
                                var L = $.jgrid.getXmlData(e, d.root, !0);
                                L = $.jgrid.getXmlData(L, d.row, !0);
                                L || (L = []);
                                var O, G = L.length, H = 0, z = [], B = parseInt(i.p.rowNum, 10), W = i.p.scroll ? $.jgrid.randId() : 1;
                                G > 0 && i.p.page <= 0 && (i.p.page = 1);
                                if (L && G) {
                                    s && (B *= s + 1);
                                    var Y, U = $.isFunction(i.p.afterInsertRow), V = !1;
                                    if (i.p.grouping) {
                                    ...
                                    for (; G > H;) {
                                        ...
                                        if (d.repeatitems) {
                                            _ || (_ = b(E + F + R));
                                            var X = $.jgrid.getXmlData(j, d.cell, !0);
                                            $.each(_, function (e) {
                                                var t = X[this];
                                                if (!t)return !1;
                                                y = t.textContent || t.text;
                                                P[i.p.colModel[e + E + F + R].name] = y;
                                                A.push(f(x, y, e + E + F + R, H + r, j, P))
                                            })
                                        } else for (p = 0; p < q.length; p++) {
                                            y = $.jgrid.getXmlData(j, q[p]);
                                            P[i.p.colModel[p + E + F + R].name] = y;
                                            A.push(f(x, y, p + E + F + R, H + r, j, P))
                                        }
                                        A[K] = C(x, V, I, P, j, !1);
                                        A.push("</tr>");
                                        if (i.p.grouping) {
                                        ...
                                        if (n || i.p.treeGrid === !0) {
                                            P[l] = $.jgrid.stripPref(i.p.idPrefix, x);
                                            i.p.data.push(P);
                                            i.p._index[P[l]] = i.p.data.length - 1
                                        }
                                        if (i.p.gridview === !1) {
                                            $("tbody:first", t).append(A.join(""));
                                            T.triggerHandler("jqGridAfterInsertRow", [x, P, j]);
                                            U && i.p.afterInsertRow.call(i, x, P, j);
                                            A = []
                                        }
                                        P = {};
                                        S++;
                                ...
                                if (n) {
                                    for (; G > S;) {
                                        ...
                                        if (d.repeatitems) {
                                            _ || (_ = b(E + F + R));
                                            var J = $.jgrid.getXmlData(j, d.cell, !0);
                                            $.each(_, function (e) {
                                                var t = J[this];
                                                if (!t)return !1;
                                                y = t.textContent || t.text;
                            ...
                            if (e) {
                                ...
                                var n, l, d = "_id_", u = "local" !== i.p.datatype && i.p.loadonce || "jsonstring" === i.p.datatype;
                                if (u) {
                                    i.p.data = [];
                                    i.p._index = {};
                                ...
                                var p, h, y, N, D, k, _, j, x, I, T, S, E = $(i), F = 0, R = [], q = i.p.multiselect ? 1 : 0, P = i.p.subGrid === !0 ? 1 : 0, A = i.p.rownumbers === !0 ? 1 : 0, M = b(q + P + A), L = v(l), O = {}, G = [], H = i.p.altRows === !0 ? i.p.altclass : "";
                                i.p.page = c($.jgrid.getAccessor(e, n.page), i.p.page);
                                i.p.lastpage = c($.jgrid.getAccessor(e, n.total), 1);
                                i.p.records = c($.jgrid.getAccessor(e, n.records));
                                i.p.userData = $.jgrid.getAccessor(e, n.userdata) || {};
                                P && (D = $.jgrid.getMethod("addSubGridCell"));
                                x = i.p.keyName === !1 ? $.isFunction(n.id) ? n.id.call(i, e) : n.id : i.p.keyName;
                                j = $.jgrid.getAccessor(e, n.root);
                                null == j && $.isArray(e) && (j = e);
                                j || (j = []);
                                _ = j.length;
                                h = 0;
                                _ > 0 && i.p.page <= 0 && (i.p.page = 1);
                                var z, B, W = parseInt(i.p.rowNum, 10), Y = i.p.scroll ? $.jgrid.randId() : 1, U = !1;
                                s && (W *= s + 1);
                                "local" !== i.p.datatype || i.p.deselectAfterSort || (U = !0);
                                var V, K = $.isFunction(i.p.afterInsertRow), X = [], Q = !1;
                                if (i.p.grouping) {
                                ...
                                for (; _ > h;) {
                                    N = j[h];
                                    T = $.jgrid.getAccessor(N, x);
                                    if (void 0 === T) {
                                        "number" == typeof x && null != i.p.colModel[x + q + P + A] && (T = $.jgrid.getAccessor(N, i.p.colModel[x + q + P + A].name));
                                        if (void 0 === T) {
                                            T = Y + h;
                                            if (0 === R.length && n.cell) {
                                                var Z = $.jgrid.getAccessor(N, n.cell) || N;
                                                T = null != Z && void 0 !== Z[x] ? Z[x] : T;
                                                Z = null
                                            }
                                        }
                                    }
                                    ...
                                    k = L;
                                    if (n.repeatitems) {
                                        n.cell && (N = $.jgrid.getAccessor(N, n.cell) || N);
                                        $.isArray(N) && (k = M)
                                    }
                                    ...
                                    for (; _ > F && j[F];) {
                                        ...
                                        if (void 0 === T) {
                                            ...
                                            if (void 0 === T) {
                                                T = Y + F;
                                                if (0 === R.length && n.cell) {
                                                    var it = $.jgrid.getAccessor(N, n.cell) || N;
                                                    T = null != it && void 0 !== it[x] ? it[x] : T;
                                                    it = null
                                                }
                                            }
                                        }
                            ...
                            function e(t) {
                                ...
                                if (null != t.rules)try {
                                    ...
                                    for (i = 0; i < t.rules.length; i++) {
                                        ...
                                        if (f[o.op] && o.field) {
                                            n > 0 && s && "OR" === s && (g = g.or());
                                            g = f[o.op](g, s)(o.field, o.data, l[o.field])
                                        }
                                        n++
                                    }
                                    a && g.orEnd()
                            ...
                            var t, r, a, s = i.p.multiSort ? [] : "", o = [], n = !1, l = {}, d = [], c = [];
                            if ($.isArray(i.p.data)) {
                                ...
                                $.each(i.p.colModel, function () {
                                    ...
                                    if ("date" === r || "datetime" === r) {
                                        ...
                                        l[this.name] = {stype: r, srcfmt: t, newfmt: a, sfunc: this.sortfunc || null}
                                    } else l[this.name] = {
                                        stype: r,
                                        srcfmt: "",
                                        newfmt: "",
                                    ...
                                    } else if (!n && (this.index === i.p.sortname || this.name === i.p.sortname)) {
                                        s = this.name;
                                        n = !0
                                    }
                                });
                                if (!i.p.treeGrid) {
                                    ...
                                    i.p.multiSort ? $.each(s, function (e) {
                                        g.orderBy(this, o[e], l[this].stype, l[this].srcfmt, l[this].sfunc)
                                    }) : s && i.p.sortorder && n && ("DESC" === i.p.sortorder.toUpperCase() ? g.orderBy(i.p.sortname, "d", l[s].stype, l[s].srcfmt, l[s].sfunc) : g.orderBy(i.p.sortname, "a", l[s].stype, l[s].srcfmt, l[s].sfunc));
                                    var b = g.select(), w = parseInt(i.p.rowNum, 10), y = b.length, C = parseInt(i.p.page, 10), N = Math.ceil(y / w), D = {};
                                    if ((i.p.search || i.p.resetsearch) && i.p.grouping && i.p.groupingView._locgr) {
                                        i.p.groupingView.groups = [];
                                        var k, _, j, x = $.jgrid.getMethod("groupingPrepare");
                                        if (i.p.footerrow && i.p.userDataOnFooter) {
                                            for (_ in i.p.userData)i.p.userData.hasOwnProperty(_) && (i.p.userData[_] = 0);
                                            j = !0
                                        }
                                        for (k = 0; y > k; k++) {
                                            if (j)for (_ in i.p.userData)i.p.userData[_] += parseFloat(b[k][_] || 0);
                                            x.call($(i), b[k], k, w)
                                        }
                                    }
                                    b = b.slice((C - 1) * w, C * w);
                            ...
                            var r, a, s, o, n, l, d, u, p = "", h = i.p.pager ? "_" + $.jgrid.jqID(i.p.pager.substr(1)) : "", f = i.p.toppager ? "_" + i.p.toppager.substr(1) : "";
                            ...
                            if (i.p.scroll) {
                                ...
                                if (m) {
                                    var v = s * m, b = parseInt(i.p.records, 10) * m;
                                    $(">div:first", i.grid.bDiv).css({height: b}).children("div:first").css({
                                        height: v,
                                        display: v ? "" : "none"
                                    });
                            ...
                            if (p) {
                                ...
                                if (i.p.viewrecords)if (0 === i.p.reccount)$(".ui-paging-info", p).html(i.p.emptyrecords); else {
                                    o = s + 1;
                                    l = i.p.records;
                                    if ($.fmatter) {
                                    ...
                                    $(".ui-paging-info", p).html($.jgrid.format(i.p.recordtext, o, n, l))
                                }
                                if (i.p.pgbuttons === !0) {
                                    0 >= r && (r = a = 0);
                                    if (1 === r || 0 === r) {
                            ...
                            if (!i.grid.hDiv.loading) {
                                var t, r, a = i.p.scroll && e === !1, s = {}, o = i.p.prmNames;
                                i.p.page <= 0 && (i.p.page = Math.min(1, i.p.lastpage));
                                null !== o.search && (s[o.search] = i.p.search);
                                null !== o.nd && (s[o.nd] = (new Date).getTime());
                                null !== o.rows && (s[o.rows] = i.p.rowNum);
                                null !== o.page && (s[o.page] = i.p.page);
                                null !== o.sort && (s[o.sort] = i.p.sortname);
                                null !== o.order && (s[o.order] = i.p.sortorder);
                                null !== i.p.rowTotal && null !== o.totalrows && (s[o.totalrows] = i.p.rowTotal);
                                var n = $.isFunction(i.p.loadComplete), l = n ? i.p.loadComplete : null, d = 0;
                                e = e || 1;
                                if (e > 1)if (null !== o.npage) {
                                    s[o.npage] = e;
                                    d = e - 1;
                                    e = 1
                                } else l = function (t) {
                                    i.p.page++;
                                    i.grid.hDiv.loading = !1;
                                    n && i.p.loadComplete.call(i, t);
                                    I(e - 1)
                                }; else null !== o.npage && delete i.p.postData[o.npage];
                                if (i.p.grouping) {
                                    $(i).jqGrid("groupingSetup");
                                    var c, u = i.p.groupingView, p = "";
                                ...
                                var f = i.p.scroll ? i.rows.length - 1 : 1, g = $(i).triggerHandler("jqGridBeforeRequest");
                                    ...
                                    case"script":
                                        $.ajax($.extend({
                                            ...
                                            success: function (r, s, o) {
                                                if ($.isFunction(i.p.beforeProcessing) && i.p.beforeProcessing.call(i, r, s, o) === !1)x(); else {
                            ...
                            var r, a, o, n, l, d, u, p = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>", h = "", f = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", g = "", m = function (e) {
                                var t;
                            ...
                            o = e + "_center";
                            n = e + "_right";
                            $("#" + $.jgrid.jqID(e)).append("<div id='" + r + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + a + "' align='left'></td><td id='" + o + "' align='center' style='white-space:pre;'></td><td id='" + n + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                            ...
                            if (i.p.pgbuttons === !0) {
                                ...
                                $("#first" + $.jgrid.jqID(t) + ", #prev" + $.jgrid.jqID(t) + ", #next" + $.jgrid.jqID(t) + ", #last" + $.jgrid.jqID(t)).click(function () {
                                    ...
                                    var e = c(i.p.page, 1), r = c(i.p.lastpage, 1), a = !1, s = !0, o = !0, n = !0, l = !0;
                                    if (0 === r || 1 === r) {
                                        s = !1;
                                        o = !1;
                                        n = !1;
                            ...
                            var r, a, s = "", o = i.p.colModel, n = !1, l = i.p.frozenColumns ? t : i.grid.headers[e].el, d = "";
                            $("span.ui-grid-ico-sort", l).addClass("ui-state-disabled");
                            $(l).attr("aria-selected", "false");
                            if (o[e].lso)if ("asc" === o[e].lso) {
                                o[e].lso += "-desc";
                                d = "desc"
                            } else if ("desc" === o[e].lso) {
                                o[e].lso += "-asc";
                                d = "asc"
                            } else("asc-desc" === o[e].lso || "desc-asc" === o[e].lso) && (o[e].lso = ""); else o[e].lso = d = o[e].firstsortorder || "asc";
                            if (d) {
                                $("span.s-ico", l).show();
                            ...
                            if (i.p.colModel[t].sortable && !(i.p.savedRow.length > 0)) {
                                ...
                                if (i.p.multiSort)E(t, s); else {
                                    if (a) {
                                        if (i.p.lastsort === t && i.p.sortorder === a && !r)return;
                                        i.p.sortorder = a
                                    }
                                    var o = i.grid.headers[i.p.lastsort].el, n = i.p.frozenColumns ? s : i.grid.headers[t].el;
                                    ...
                                    $("span.ui-icon-" + i.p.sortorder, n).removeClass("ui-state-disabled");
                                ...
                                if ("stop" !== $(i).triggerHandler("jqGridSortCol", [i.p.sortname, t, i.p.sortorder]))if ($.isFunction(i.p.onSortCol) && "stop" === i.p.onSortCol.call(i, i.p.sortname, t, i.p.sortorder))i.p.lastsort = t; else {
                                    if ("local" === i.p.datatype)i.p.deselectAfterSort && $(i).jqGrid("resetSelection"); else {
                                        i.p.selrow = null;
                                        i.p.multiselect && T(!1);
                                        i.p.selarrrow = [];
                                        i.p.savedRow = []
                            ...
                            var e, t, a, s, o = 0, n = $.jgrid.cell_width ? 0 : c(i.p.cellLayout, 0), l = 0, d = c(i.p.scrollOffset, 0), u = !1, p = 0;
                            $.each(i.p.colModel, function () {
                            ...
                            isNaN(i.p.width) && (i.p.width = o + (i.p.shrinkToFit !== !1 || isNaN(i.p.height) ? 0 : d));
                            r.width = i.p.width;
                            i.p.tblwidth = o;
                            ...
                            if (i.p.shrinkToFit === !0 && l > 0) {
                                ...
                                $.each(i.p.colModel, function (r) {
                                    if (this.hidden === !1 && !this.fixed) {
                                        t = Math.round(a * this.width / (i.p.tblwidth - n * l - p));
                                        this.width = t;
                                        o += t;
                                        e = r
                                    }
                                ...
                                s = 0;
                                u ? r.width - p - (o + n * l) !== d && (s = r.width - p - (o + n * l) - d) : u || 1 === Math.abs(r.width - p - (o + n * l)) || (s = r.width - p - (o + n * l));
                                i.p.colModel[e].width += s;
                                i.p.tblwidth = o + s + n * l + p;
                            ...
                            var t = $(i.grid.headers[e].el), r = [t.position().left + t.outerWidth()];
                        ...
                        if (this.p.treeGrid === !0) {
                            ...
                            "local" !== i.p.datatype && (i.p.localReader = {id: "_id_"})
                        }
                        ...
                        i.p.data.length && y();
                        var O, G, H, z, B, W, Y, U, V, K = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", X = "", Q = "", Z = [], J = [], et = [];
                        ...
                        var ot = $("tr:first", K), nt = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                        i.p.disableClick = !1;
                        $("th", ot).each(function (e) {
                            ...
                            nt += "<td role='gridcell' style='height:0px;width:" + H + "px;" + t + "'></td>";
                            r.headers[e] = {width: H, el: this};
                            ...
                            if (1 === s.length) {
                                ...
                                null != o && F($("div", this)[0].id, o, t, r, this);
                                return !1
                            }
                        });
                        if (i.p.sortable && $.fn.sortable)try {
                            $(i).jqGrid("sortableColumns", ot)
                        } catch (lt) {
                        }
                        ...
                        this.appendChild(U);
                        $(this).addClass("ui-jqgrid-btable").append(nt);
                        nt = null;
                        var dt = $("<table class='ui-jqgrid-htable' style='width:" + i.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(K), ct = i.p.caption && i.p.hiddengrid === !0 ? !0 : !1, ut = $("<div class='ui-jqgrid-hbox" + ("rtl" === s ? "-rtl" : "") + "'></div>");
                        K = null;
                        r.hDiv = document.createElement("div");
                        $(r.hDiv).css({width: r.width + "px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(ut);
                        $(ut).append(dt);
                        dt = null;
                        ct && $(r.hDiv).hide();
                        if (i.p.pager) {
                            "string" == typeof i.p.pager ? "#" !== i.p.pager.substr(0, 1) && (i.p.pager = "#" + i.p.pager) : i.p.pager = "#" + $(i.p.pager).attr("id");
                            $(i.p.pager).css({width: r.width + "px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(l);
                            ct && $(i.p.pager).hide();
                            S(i.p.pager, "")
                        }
                        ...
                        $(i).before(r.hDiv).click(function (e) {
                            ...
                            var t = $(W).hasClass("cbox"), r = $(i).triggerHandler("jqGridBeforeSelectRow", [Y[0].id, e]);
                            r = r === !1 || "stop" === r ? !1 : !0;
                            ...
                            if ("A" !== W.tagName && ("INPUT" !== W.tagName && "TEXTAREA" !== W.tagName && "OPTION" !== W.tagName && "SELECT" !== W.tagName || t) && r === !0) {
                                ...
                                if (i.p.cellEdit === !0)if (i.p.multiselect && t)$(i).jqGrid("setSelection", pt, !0, e); else {
                                    pt = Y[0].rowIndex;
                                    try {
                                    ...
                                    if (e[i.p.multikey])$(i).jqGrid("setSelection", pt, !0, e); else if (i.p.multiselect && t) {
                                        t = $("#jqg_" + $.jgrid.jqID(i.p.id) + "_" + pt).is(":checked");
                                        $("#jqg_" + $.jgrid.jqID(i.p.id) + "_" + pt)[i.p.useProp ? "prop" : "attr"]("checked", t)
                                    }
                                } else if (i.p.multiselect && i.p.multiboxonly)if (t)$(i).jqGrid("setSelection", pt, !0, e); else {
                        ...
                        n && "auto" === String(i.p.height).toLowerCase() && (i.p.height = "100%");
                        $(r.bDiv).append($('<div style="position:relative;' + (n && $.jgrid.msiever() < 8 ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                            height: i.p.height + (isNaN(i.p.height) ? "" : "px"),
                            width: r.width + "px"
                        }).scroll(r.scrollGrid);
                        $("table:first", r.bDiv).css({width: i.p.tblwidth + "px"});
                        ...
                        if (i.p.caption) {
                            ...
                            if (i.p.hidegrid === !0) {
                                $(".ui-jqgrid-titlebar-close", r.cDiv).click(function (e) {
                                    var t, a = $.isFunction(i.p.onHeaderClick), s = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", o = this;
                                    if (i.p.toolbar[0] === !0) {
                        ...
                        $.extend(r, {populate: I, emptyRows: w, beginReq: j, endReq: x});
                        this.grid = r;
    ...
    $.jgrid.extend({
        getGridParam: function (e) {
            ...
            return this.each(function () {
                function r(e) {
                    var t = $(u.grid.bDiv)[0].clientHeight, i = $(u.grid.bDiv)[0].scrollTop, r = $(u.rows[e]).position().top, a = u.rows[e].clientHeight;
                    r + a >= t + i ? $(u.grid.bDiv)[0].scrollTop = r - (t + i) + a + i : t + i > r && i > r && ($(u.grid.bDiv)[0].scrollTop = r)
                }

                var a, s, o, n, l, d, c, u = this;
                if (void 0 !== e) {
                    t = t === !1 ? !1 : !0;
                    s = $(u).jqGrid("getGridRowById", e);
                    if (s && s.className && !(s.className.indexOf("ui-state-disabled") > -1)) {
                        if (u.p.scrollrows === !0) {
                            o = $(u).jqGrid("getGridRowById", e).rowIndex;
                            o >= 0 && r(o)
                        }
                        ...
                        if (u.p.multiselect) {
                            u.setHeadCheckBox(!1);
                            u.p.selrow = s.id;
                            n = $.inArray(u.p.selrow, u.p.selarrrow);
                            if (-1 === n) {
                                ...
                                a = !1;
                                u.p.selarrrow.splice(n, 1);
                                l = u.p.selarrrow[0];
                                u.p.selrow = void 0 === l ? null : l
                            }
                            $("#jqg_" + $.jgrid.jqID(u.p.id) + "_" + $.jgrid.jqID(s.id))[u.p.useProp ? "prop" : "attr"]("checked", a);
                            if (d) {
                                -1 === n ? $("#" + $.jgrid.jqID(e), "#" + $.jgrid.jqID(d)).addClass("ui-state-highlight") : $("#" + $.jgrid.jqID(e), "#" + $.jgrid.jqID(d)).removeClass("ui-state-highlight");
                            ...
                            if (u.p.selrow !== s.id) {
                                ...
                                $(s).addClass("ui-state-highlight").attr({"aria-selected": "true", tabindex: "0"});
                                if (d) {
            ...
            this.each(function () {
                ...
                if (void 0 === e) {
                    ...
                    n = $(l).jqGrid("getGridRowById", e);
                    if (!n)return r;
                    i = 2
                }
                for (; i > s;) {
                    a && (n = l.rows[s]);
                    if ($(n).hasClass("jqgrow")) {
                        $('td[role="gridcell"]', n).each(function (e) {
                            o = l.p.colModel[e].name;
                            if ("cb" !== o && "subgrid" !== o && "rn" !== o)if (l.p.treeGrid === !0 && o === l.p.ExpandColumn)r[o] = $.jgrid.htmlDecode($("span:first", this).html()); else try {
                                r[o] = $.unformat.call(l, this, {rowId: n.id, colModel: l.p.colModel[e]}, e)
                            } catch (t) {
                                r[o] = $.jgrid.htmlDecode($(this).html())
                            }
                        });
                        if (a) {
                            t.push(r);
            ...
            this.each(function () {
                ...
                if ("local" === s.p.datatype) {
                    var o = $.jgrid.stripPref(s.p.idPrefix, e), n = s.p._index[o];
                    if (void 0 !== n) {
                        s.p.data.splice(n, 1);
                        s.refreshIndex()
                    }
            ...
            this.each(function () {
                ...
                var o, n, l = this, d = typeof i, c = {};
                n = $(this).jqGrid("getGridRowById", e);
                if (!n)return !1;
                if (t)try {
                    $(this.p.colModel).each(function (i) {
                        ...
                        if (void 0 !== s) {
                            ...
                            o = l.formatter(e, s, i, t, "edit");
                            a = this.title ? {title: $.jgrid.stripHtml(o)} : {};
                            l.p.treeGrid === !0 && r === l.p.ExpandColumn ? $("td[role='gridcell']:eq(" + i + ") > span:first", n).html(o).attr(a) : $("td[role='gridcell']:eq(" + i + ")", n).html(o).attr(a)
                        }
                    });
                    if ("local" === l.p.datatype) {
                        var u, p = $.jgrid.stripPref(l.p.idPrefix, e), h = l.p._index[p];
                ...
                if (s) {
                    "string" === d ? $(n).addClass(i) : null !== i && "object" === d && $(n).css(i);
            ...
            var a, s, o, n, l, d, c, u, p, h, f, g, m, v, b = !1, w = "";
            if (t) {
                if ($.isArray(t)) {
                    p = !0;
                    h = e
                ...
                this.each(function () {
                    var y = this, C = t.length;
                    l = y.p.rownumbers === !0 ? 1 : 0;
                    o = y.p.multiselect === !0 ? 1 : 0;
                    n = y.p.subGrid === !0 ? 1 : 0;
                    if (!p)if (void 0 !== e)e = String(e); else {
                        e = $.jgrid.randId();
                        if (y.p.keyName !== !1) {
                            h = y.p.keyName;
                    ...
                    for (var N = 0, D = "", k = {}, _ = $.isFunction(y.p.afterInsertRow) ? !0 : !1; C > N;) {
                        ...
                        n && (s[s.length] = $(y).jqGrid("addSubGridCell", o + l, 1));
                        for (c = o + n + l; c < y.p.colModel.length; c++) {
                            m = y.p.colModel[c];
                            a = m.name;
                            k[a] = g[a];
                        ...
                        s[s.length] = "</tr>";
                        if (0 === y.rows.length)$("table:first", y.grid.bDiv).append(s.join("")); else switch (i) {
                            case"last":
                        ...
                        y.p.subGrid === !0 && $(y).jqGrid("addSubGrid", o + l, d);
                        y.p.records++;
                        y.p.reccount++;
                ...
                $(this.p.colModel).each(function (r) {
                    ...
                    if ("set" === e) {
                        if (void 0 !== t[a]) {
                            ...
                            s = this.title ? {title: $.jgrid.stripHtml(l)} : {};
                            $("tr.footrow td:eq(" + r + ")", d.grid.sDiv).html(l).attr(s);
                            o = !0
                        }
                    } else"get" === e && (n[a] = $("tr.footrow td:eq(" + r + ")", d.grid.sDiv).html())
                })
            });
            return "get" === e ? n : o
        }, showHideCol: function (e, t) {
            return this.each(function () {
                var i, r = this, a = !1, s = $.jgrid.cell_width ? 0 : r.p.cellLayout;
                if (r.grid) {
                    "string" == typeof e && (e = [e]);
                    t = "none" !== t ? "" : "none";
                    var o = "" === t ? !0 : !1, n = r.p.groupHeader && ("object" == typeof r.p.groupHeader || $.isFunction(r.p.groupHeader));
                    n && $(r).jqGrid("destroyGroupHeader", !1);
                    $(this.p.colModel).each(function (n) {
                        if (-1 !== $.inArray(this.name, e) && this.hidden === o) {
                            ...
                            r.p.footerrow && $("tr.footrow td:eq(" + n + ")", r.grid.sDiv).css("display", t);
                            i = parseInt(this.width, 10);
                            "none" === t ? r.p.tblwidth -= i + s : r.p.tblwidth += i + s;
                            this.hidden = !o;
                            a = !0;
                            $(r).triggerHandler("jqGridShowHideCol", [o, this.name, n])
                        }
                    });
                    if (a === !0) {
            ...
            return this.each(function () {
                if (this.grid) {
                    var i, r, a, s, o = this, n = 0, l = $.jgrid.cell_width ? 0 : o.p.cellLayout, d = 0, c = !1, u = o.p.scrollOffset, p = 0;
                    "boolean" != typeof t && (t = o.p.shrinkToFit);
                    if (!isNaN(e)) {
                        e = parseInt(e, 10);
                        o.grid.width = o.p.width = e;
                        $("#gbox_" + $.jgrid.jqID(o.p.id)).css("width", e + "px");
                        $("#gview_" + $.jgrid.jqID(o.p.id)).css("width", e + "px");
                        $(o.grid.bDiv).css("width", e + "px");
                        $(o.grid.hDiv).css("width", e + "px");
                        o.p.pager && $(o.p.pager).css("width", e + "px");
                        o.p.toppager && $(o.p.toppager).css("width", e + "px");
                        if (o.p.toolbar[0] === !0) {
                            $(o.grid.uDiv).css("width", e + "px");
                            "both" === o.p.toolbar[1] && $(o.grid.ubDiv).css("width", e + "px")
                        }
                        o.p.footerrow && $(o.grid.sDiv).css("width", e + "px");
                        t === !1 && o.p.forceFit === !0 && (o.p.forceFit = !1);
                        if (t === !0) {
                            ...
                            o.p.tblwidth = n;
                            a = e - l * d - p;
                            if (!isNaN(o.p.height) && ($(o.grid.bDiv)[0].clientHeight < $(o.grid.bDiv)[0].scrollHeight || 1 === o.rows.length)) {
                                c = !0;
                                a -= u
                            }
                            n = 0;
                            var h = o.grid.cols.length > 0;
                            $.each(o.p.colModel, function (e) {
                                if (this.hidden === !1 && !this.fixed) {
                                    i = this.widthOrg;
                                    i = Math.round(a * i / (o.p.tblwidth - l * d - p));
                                    if (0 > i)return;
                                    this.width = i;
                                    n += i;
                                    o.grid.headers[e].width = i;
                                    o.grid.headers[e].el.style.width = i + "px";
                                    o.p.footerrow && (o.grid.footers[e].style.width = i + "px");
                                    h && (o.grid.cols[e].style.width = i + "px");
                                    r = e
                                }
                            });
                            if (!r)return;
                            s = 0;
                            c ? e - p - (n + l * d) !== u && (s = e - p - (n + l * d) - u) : 1 !== Math.abs(e - p - (n + l * d)) && (s = e - p - (n + l * d));
                            o.p.colModel[r].width += s;
                            o.p.tblwidth = n + s + l * d + p;
                            if (o.p.tblwidth > e) {
                                var f = o.p.tblwidth - parseInt(e, 10);
                                o.p.tblwidth = e;
                                i = o.p.colModel[r].width = o.p.colModel[r].width - f
                            } else i = o.p.colModel[r].width;
                            o.grid.headers[r].width = i;
                            o.grid.headers[r].el.style.width = i + "px";
                            h && (o.grid.cols[r].style.width = i + "px");
                            o.p.footerrow && (o.grid.footers[r].style.width = i + "px")
                        }
                        if (o.p.tblwidth) {
                            $("table:first", o.grid.bDiv).css("width", o.p.tblwidth + "px");
            ...
            return this.each(function () {
                ...
                if (a.grid && void 0 !== e) {
                    ...
                    if (s >= 0) {
                        var o = $("tr.ui-jqgrid-labels th:eq(" + s + ")", a.grid.hDiv);
                        if (t) {
                            var n = $(".s-ico", o);
                            $("[id^=jqgh_]", o).empty().html(t).append(n);
                            a.p.colNames[s] = t
                        }
                        i && ("string" == typeof i ? $(o).addClass(i) : $(o).css(i));
                        "object" == typeof r && $(o).attr(r)
                    }
                }
            })
            ...
            return this.each(function () {
                ...
                if (l.grid) {
                    ...
                    if (d >= 0) {
                        ...
                        if (c) {
                            var u = $("td:eq(" + d + ")", c), p = 0, h = [];
                            if ("" !== i || s === !0) {
                                for (; p < c.cells.length;) {
                                    h.push(c.cells[p].innerHTML);
                                    p++
                                }
                                o = l.formatter(e, i, d, h, "edit");
                                n = l.p.colModel[d].title ? {title: $.jgrid.stripHtml(o)} : {};
                                l.p.treeGrid && $(".tree-wrap", $(u)).length > 0 ? $("span", $(u)).html(o).attr(n) : $(u).html(o).attr(n);
                                if ("local" === l.p.datatype) {
                                    var f, g = l.p.colModel[d];
                                    i = g.formatter && "string" == typeof g.formatter && "date" === g.formatter ? $.unformat.date.call(l, i, g) : i;
                                    f = l.p._index[$.jgrid.stripPref(l.p.idPrefix, e)];
                                    void 0 !== f && (l.p.data[f][g.name] = i)
                                }
                            }
                        ...
                        if (u && u > 0) {
                            for (; u > p;) {
                                if ($(d.rows[p]).hasClass("jqgrow")) {
                                    ...
                                    } else n.push(t ? {id: d.rows[p].id, value: r} : r)
                                }
                                p++
                            }
            ...
            return this.each(function () {
                ...
                $(e).keydown(function (i) {
                    var r, a, s, o = $(e).find("tr[tabindex=0]")[0], n = e.p.treeReader.expanded_field;
                    if (o) {
                        s = e.p._index[$.jgrid.stripPref(e.p.idPrefix, o.id)];
                        if (37 === i.keyCode || 38 === i.keyCode || 39 === i.keyCode || 40 === i.keyCode) {
                            ...
                            if (37 === i.keyCode) {
                                e.p.treeGrid && e.p.data[s][n] && $(o).find("div.treeclick").trigger("click");
...
!function (e) {
    ...
    e.jgrid.extend({
        getColProp: function (e) {
                ...
                if (!this.ftoolbar) {
                    var r, a = function () {
                        ...
                        if (t.stringResult === !0 || "local" === i.p.datatype || t.searchOperators === !0) {
                            var c = '{"groupOp":"' + t.groupOp + '","rules":[', u = 0;
                            ...
                            c += "]}";
                            e.extend(i.p.postData, {filters: c});
                        ...
                        h || e(i).jqGrid("setGridParam", {search: d}).trigger("reloadGrid", [{page: 1}]);
                        ...
                        if (t.stringResult === !0 || "local" === i.p.datatype) {
                            var l = '{"groupOp":"' + t.groupOp + '","rules":[', d = 0;
                            ...
                            l += "]}";
                            e.extend(i.p.postData, {filters: l});
                            e.each(["searchField", "searchString", "searchOper"], function (e, t) {
                                i.p.postData.hasOwnProperty(t) && delete i.p.postData[t]
                            })
                        ...
                        u || r && e(i).jqGrid("setGridParam", {search: n}).trigger("reloadGrid", [{page: 1}]);
                        c && e(i).jqGrid("setGridParam", {url: c});
                        e(i).triggerHandler("jqGridToolbarAfterClear");
                        e.isFunction(t.afterClear) && t.afterClear()
                    }, o = function () {
                        var t = e("tr.ui-search-toolbar", i.grid.hDiv), r = i.p.frozenColumns === !0 ? e("tr.ui-search-toolbar", i.grid.fhDiv) : !1;
                        ...
                        var v = i.p.colModel[h], m = e.extend({}, v.searchoptions);
                        if (!m.sopt) {
                            m.sopt = [];
                            m.sopt[0] = "select" === v.stype ? "eq" : t.defaultSearch
                        }
                        e.each(t.odata, function () {
                            p.push(this.oper)
                        });
                        for (h = 0; h < m.sopt.length; h++) {
                            l = e.inArray(m.sopt[h], p);
                            if (-1 !== l) {
                        ...
                        e("#sopt_menu > li > a").hover(function () {
                            ...
                            var s = e(this).attr("value"), o = e(this).attr("oper");
                    ...
                    e.each(i.p.colModel, function (s) {
                        var o, n, d, c, u, p = this, h = "", f = "=", g = e("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + i.p.direction + "'></th>"), v = e("<div style='position:relative;height:auto;padding-right:0.3em;padding-left:0.3em;'></div>"), m = e("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");
                        ...
                        if (this.search) {
                            ...
                            e("td:eq(0)", m).attr("colindex", s).append(h);
                            void 0 === o.clearSearch && (o.clearSearch = !0);
                            if (o.clearSearch) {
                                var w = t.resetTitle || "Clear Search Value";
                                e("td:eq(2)", m).append("<a title='" + w + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + t.resetIcon + "</a>")
                            } else e("td:eq(2)", m).hide();
                            switch (this.stype) {
                                case"select":
                                    ...
                                    if (n) {
                                        ...
                                        e(d).append(m);
                                        e.ajax(e.extend({
                                            url: n, dataType: "html", success: function (r) {
                                                if (void 0 !== o.buildSelect) {
                                                    var s = o.buildSelect(r);
                                                    s && e("td:eq(1)", m).append(s)
                                                } else e("td:eq(1)", m).append(r);
                                                void 0 !== o.defaultValue && e("select", d).val(o.defaultValue);
                                                e("select", d).attr({name: p.index || p.name, id: "gs_" + p.name});
                                                o.attr && e("select", d).attr(o.attr);
                                                e("select", d).css({width: "100%"});
                                        ...
                                        if (y) {
                                            ...
                                            N.style.width = "100%";
                                            e(N).attr({name: p.index || p.name, id: "gs_" + p.name});
                                            var $, _, j, k;
                                            if ("string" == typeof y) {
                                                c = y.split(D);
                                ...
                                case"text":
                                    ...
                                    e("td:eq(1)", m).append("<input type='text' style='width:100%;padding:0px;' name='" + (p.index || p.name) + "' id='gs_" + p.name + "' value='" + x + "'/>");
                                    e(v).append(m);
                                    o.attr && e("input", v).attr(o.attr);
                                    e.jgrid.bindEv.call(i, e("input", v)[0], o);
                                    t.autosearch === !0 && (t.searchOnEnter ? e("input", v).keypress(function (e) {
                                        var t = e.charCode || e.keyCode || 0;
                                        if (13 === t) {
                                            a();
                                            return !1
                                    ...
                                    break;
                                case"custom":
                                    e("td:eq(1)", m).append("<span style='width:95%;padding:0px;' name='" + (p.index || p.name) + "' id='gs_" + p.name + "'/>");
                                    e(v).append(m);
                                    try {
                                        ...
                                        e(v).find("span[name='" + (p.index || p.name) + "']").append(I)
                                    } catch (T) {
                        ...
                        e(g).append(v);
                        e(l).append(g);
                        t.searchOperators || e("td:eq(0)", m).hide()
                    });
                    e("table thead", i.grid.hDiv).append(l);
                    if (t.searchOperators) {
                        e(".soptclass", l).click(function (t) {
                            var i = e(this).offset(), r = i.left, a = i.top;
                            n(this, r, a);
                            t.stopPropagation()
                        });
                    ...
                    e(".clearsearchclass", l).click(function () {
                        var r = e(this).parents("tr:first"), s = parseInt(e("td.ui-search-oper", r).attr("colindex"), 10), o = e.extend({}, i.p.colModel[s].searchoptions || {}), n = o.defaultValue ? o.defaultValue : "";
            ...
            void 0 === t && (t = !0);
            return this.each(function () {
                var i, r, a, s, o, n, l, d = this, c = d.grid, u = e("table.ui-jqgrid-htable thead", c.hDiv), p = d.p.colModel;
                if (c) {
                    e(this).unbind(".setGroupHeaders");
                    i = e("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels");
                    s = c.headers;
                    ...
                    e(u).prepend(i);
                    t === !0 && e(d).jqGrid("setGridParam", {groupHeader: null})
                }
            })
            ...
            return this.each(function () {
                ...
                var i, r, a, s, o, n, l, d, c, u, p, h, f, g = this, v = 0, m = g.p.colModel, b = m.length, w = g.grid.headers, y = e("table.ui-jqgrid-htable", g.grid.hDiv), C = y.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"), D = y.children("thead"), N = y.find(".jqg-first-row-header");
                void 0 === N[0] ? N = e("<tr>", {
                    role: "row",
                    "aria-hidden": "true"
                ...
                e(g).prepend(D);
                a = e("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");
                for (i = 0; b > i; i++) {
                    o = w[i].el;
                    n = e(o);
                    r = m[i];
                    l = {height: "0px", width: w[i].width + "px", display: r.hidden ? "none" : ""};
                    e("<th>", {role: "gridcell"}).css(l).addClass("ui-first-th-" + g.p.direction).appendTo(N);
                    o.style.width = "";
                    ...
                    if (d >= 0) {
                        ...
                        u = c.numberOfColumns;
                        p = c.titleText;
                        for (h = 0, d = 0; u > d && b > i + d; d++)m[i + d].hidden || h++;
                        s = e("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + g.p.direction).css({
                            height: "22px",
                            "border-top": "0 none"
                        }).html(p);
                        ...
                        a.append(o);
                        v = u - 1
                    } else if (0 === v)if (t.useColSpanStyle)n.attr("rowspan", "2"); else {
                        e("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + g.p.direction).css({
            ...
            return this.each(function () {
                if (this.grid) {
                    var t = this, i = t.p.colModel, r = 0, a = i.length, s = -1, o = !1;
                    if (t.p.subGrid !== !0 && t.p.treeGrid !== !0 && t.p.cellEdit !== !0 && !t.p.sortable && !t.p.scroll) {
                        ...
                        if (s >= 0 && o) {
                            var n = t.p.caption ? e(t.grid.cDiv).outerHeight() : 0, l = e(".ui-jqgrid-htable", "#gview_" + e.jgrid.jqID(t.p.id)).height();
                            ...
                            e(t).bind("jqGridSortCol.setFrozenColumns", function (i, r, a) {
                                var s = e("tr.ui-jqgrid-labels:last th:eq(" + t.p.lastsort + ")", t.grid.fhDiv), o = e("tr.ui-jqgrid-labels:last th:eq(" + a + ")", t.grid.fhDiv);
...
!function (e) {
    ...
    e.extend(e.jgrid, {
        showModal: function (e) {
            ...
            if (e.fn.jqm && i.jqm === !0)e(t).attr("aria-hidden", "true").jqmHide(); else {
                if ("" !== i.gb)try {
            ...
            var l, d = document.createElement("div"), c = this;
            n = e.extend({}, n || {});
            ...
            e("a.ui-jqdialog-titlebar-close", u).click(function () {
                var i = e("#" + e.jgrid.jqID(t.themodal)).data("onClose") || r.onClose, a = e("#" + e.jgrid.jqID(t.themodal)).data("gbox") || r.gbox;
                c.hideModal("#" + e.jgrid.jqID(t.themodal), {gb: a, jqm: r.jqModal, onClose: i});
                return !1
            });
            ...
            e(d).css(e.extend({
                ...
                zIndex: r.zIndex,
                overflow: "hidden"
            }, f)).attr({tabIndex: "-1", role: "dialog", "aria-labelledby": t.modalhead, "aria-hidden": "true"});
            void 0 === r.drag && (r.drag = !0);
            void 0 === r.resize && (r.resize = !0);
            if (r.drag) {
                e(u).css("cursor", "move");
                if (e.fn.jqDrag)e(d).jqDrag(u); else try {
                    e(d).draggable({handle: e("#" + e.jgrid.jqID(u.id))})
                } catch (b) {
                }
            }
            if (r.resize)if (e.fn.jqResize) {
                ...
                e(d).resizable({handles: "se, sw", alsoResize: t.scrollelm ? "#" + e.jgrid.jqID(t.scrollelm) : !1})
            } catch (w) {
            }
            r.closeOnEscape === !0 && e(d).keydown(function (i) {
                if (27 == i.which) {
                    var a = e("#" + e.jgrid.jqID(t.themodal)).data("onClose") || r.onClose;
                    c.hideModal("#" + e.jgrid.jqID(t.themodal), {gb: r.gbox, jqm: r.jqModal, onClose: a})
                }
            })
            ...
            if (e.fn.jqm && i.jqm === !0)i.jqM ? e(t).attr("aria-hidden", "false").jqm(i).jqmShow() : e(t).attr("aria-hidden", "false").jqmShow(); else {
                if ("" !== i.gbox) {
            ...
            e.extend(!0, s, e.jgrid.jqModal || {}, {caption: "<b>" + t + "</b>"}, a || {});
            var o = s.jqModal, n = this;
            e.fn.jqm && !o && (o = !1);
            var l, d = "";
            ...
            var c = isNaN(s.dataheight) ? s.dataheight : s.dataheight + "px", u = "text-align:" + s.align + ";", p = "<div id='info_id'>";
            ...
            p += "</div>";
            try {
                "false" === e("#info_dialog").attr("aria-hidden") && e.jgrid.hideModal("#info_dialog", {jqm: o});
            ...
            switch (t) {
                case"textarea":
                    ...
                    a ? i.cols || e(n).css({width: "98%"}) : i.cols || (i.cols = 20);
                    i.rows || (i.rows = 2);
                ...
                case"select":
                    ...
                    if (void 0 !== i.dataUrl) {
                        var h = i.name ? String(i.id).substring(0, String(i.id).length - String(i.name).length - 1) : String(i.id), f = i.postData || s.postData;
                        ...
                        e.ajax(e.extend({
                            ...
                            success: function (t) {
                                var i = [], r = this.elem, a = this.vl, s = e.extend({}, this.options), n = s.multiple === !0, d = e.isFunction(s.buildSelect) ? s.buildSelect.call(l, t) : t;
                        ...
                        var m, v, b, w = void 0 === i.separator ? ":" : i.separator, y = void 0 === i.delimiter ? ";" : i.delimiter;
                ...
                case"button":
                    ...
                    n.value = r;
                    o(n, i);
                    "button" !== t && (a ? i.size || e(n).css({width: "100%"}) : i.size || (i.size = 20));
                ...
                case"custom":
                    ...
                    try {
                        ...
                        if (!N)throw"e2";
                        N = e(N).addClass("customelement").attr({id: i.id, name: i.name});
                        e(n).addClass("pr").empty().append(N);
                        i.trigger && e(n).append('<span class="' + i.trigger + '"></span>')
                    } catch ($) {
                        "e1" === $ && e.jgrid.info_dialog(e.jgrid.errors.errcap, "function 'custom_element' " + e.jgrid.edit.msg.nodefined, e.jgrid.edit.bClose);
                        "e2" === $ ? e.jgrid.info_dialog(e.jgrid.errors.errcap, "function 'custom_element' " + e.jgrid.edit.msg.novalue, e.jgrid.edit.bClose) : e.jgrid.info_dialog(e.jgrid.errors.errcap, "string" == typeof $ ? $ : $.message, e.jgrid.edit.bClose)
                    }
            }
            return n
            ...
            var s, o, n, l, d, c = this, u = c.p.colModel;
        ...
        editCell: function (t, i, r) {
            ...
            return this.each(function () {
                ...
                if (a.grid && a.p.cellEdit === !0) {
                    ...
                    if (null !== r) {
                        var s, o, n = e("td:eq(" + i + ")", a.rows[t]), l = a.p.colModel[i], d = l.name, c = e.jgrid.jqID(d);
                        switch (l.edittype) {
                            case"select":
                                if (l.editoptions.multiple) {
                                    var u = e("#" + t + "_" + c, a.rows[t]), p = [];
                                    s = e(u).val();
                                    s ? s.join(",") : s = "";
                ...
                if (a.grid && a.p.cellEdit === !0) {
                    ...
                    if (r === a.p.colModel.length) {
                        ...
                        if (0 === e(a).find("tbody tr").eq(t).length) {
                            ...
                            if (THISPAGE.newId) {
                                e(a).jqGrid("addRowData", THISPAGE.newId, {id: THISPAGE.newId}, "last");
                                THISPAGE.newId++
            ...
            return this.each(function () {
                function t(t, i, a) {
                    if ("v" === a.substr(0, 1)) {
                        var s = e(r.grid.bDiv)[0].clientHeight, o = e(r.grid.bDiv)[0].scrollTop, n = r.rows[t].offsetTop + r.rows[t].clientHeight, l = r.rows[t].offsetTop;
                    ...
                    if ("h" === a) {
                        var d = e(r.grid.bDiv)[0].clientWidth, c = e(r.grid.bDiv)[0].scrollLeft, u = r.rows[t].cells[i].offsetLeft + r.rows[t].cells[i].clientWidth, p = r.rows[t].cells[i].offsetLeft;
                        ...
                        e("td", this).each(function (i) {
                            ...
                            if ("cb" !== r && "subgrid" !== r)if ("dirty" === t) {
                                if (e(this).hasClass("dirty-cell"))try {
                                    o[r] = e.unformat.call(a, this, {rowId: a.rows[s].id, colModel: a.p.colModel[i]}, i)
                                } catch (n) {
...
!function (e) {
    ...
    e.fmatter.util = {
        NumberFormat: function (t, i) {
            ...
            if (e.fmatter.isNumber(t)) {
                var r, a = 0 > t, o = String(t), s = i.decimalSeparator || ".";
                if (e.fmatter.isNumber(i.decimalPlaces)) {
                    var n = i.decimalPlaces, l = Math.pow(10, n);
    ...
    e.fn.fmatter.select = function (t, i) {
        ...
        if (o) {
            var n, l = i.colModel.editoptions.multiple === !0 ? !0 : !1, d = [];
            if (l) {
                d = t.split(",");
    ...
    e.fn.fmatter.rowactions = function (t) {
        var i = e(this).closest("tr.jqgrow"), r = i.attr("id"), a = e(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"), o = e("#" + a), s = o[0], n = s.p, l = n.colModel[e.jgrid.getCellIndex(this)], d = l.frozen ? e("tr#" + r + " td:eq(" + e.jgrid.getCellIndex(this) + ") > div", o) : e(this).parent(), c = {
            keys: !1,
            onEdit: null,
            onSuccess: null,
            afterSave: null,
    ...
    e.fn.fmatter.actions = function (t, i) {
        var r, a = {keys: !1, editbutton: !0, delbutton: !0, editformbutton: !1}, o = i.rowId, s = "";
    ...
    e.unformat = function (t, i, r, a) {
        var o, s, n = i.colModel.formatter, l = i.colModel.formatoptions || {}, d = /([\.\*\_\'\(\)\{\}\+\?\\])/g, c = i.colModel.unformat || e.fn.fmatter[n] && e.fn.fmatter[n].unformat;
        if (void 0 !== c && e.isFunction(c))o = c.call(this, e(t).text(), i, t); else if (void 0 !== n && e.fmatter.isString(n)) {
    ...
    e.unformat.select = function (t, i, r, a) {
        var o = [], s = e(t).text();
        if (a === !0)return s;
        var n = e.extend({}, void 0 !== i.colModel.formatoptions ? i.colModel.formatoptions : i.colModel.editoptions), l = void 0 === n.separator ? ":" : n.separator, d = void 0 === n.delimiter ? ";" : n.delimiter;
        if (n.value) {
            var c, u = n.value, p = n.multiple === !0 ? !0 : !1, h = [];
            if (p) {
                h = s.split(",");
