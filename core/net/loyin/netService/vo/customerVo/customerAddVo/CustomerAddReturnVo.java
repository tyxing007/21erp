...
public class CustomerAddReturnVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private CustomerAddReturnMainData maindata;
...
//        }
    ...
    @Override
    public CustomerAddReturnMainData getMaindata() {
        return maindata;
    }

    public void setMaindata(CustomerAddReturnMainData maindata) {
