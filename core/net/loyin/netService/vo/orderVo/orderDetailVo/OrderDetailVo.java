...
public class OrderDetailVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private OrderDetailInfo maindata;
    ...
    @Override
    public OrderDetailInfo getMaindata() {
        return maindata;
    }

    public void setMaindata(OrderDetailInfo maindata) {
