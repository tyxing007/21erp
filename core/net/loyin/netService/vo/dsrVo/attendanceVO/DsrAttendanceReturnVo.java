...
public class DsrAttendanceReturnVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private DsrAttendanceReturnMainData maindata;
    ...
    @Override
    public DsrAttendanceReturnMainData getMaindata() {
        return maindata;
    }

    public void setMaindata(DsrAttendanceReturnMainData maindata) {
