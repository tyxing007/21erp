...
public class DsrAttendanceAddReturnVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private DsrAttendanceAddReturnMainData maindata;
    ...
    @Override
    public DsrAttendanceAddReturnMainData getMaindata() {
        return maindata;
    }

    public void setMaindata(DsrAttendanceAddReturnMainData maindata) {
