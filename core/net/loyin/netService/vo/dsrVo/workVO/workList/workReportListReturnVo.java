...
public class workReportListReturnVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private workReportListReturnDataMain maindata;
    ...
    @Override
    public workReportListReturnDataMain getMaindata() {
        return maindata;
    }

    public void setMaindata(workReportListReturnDataMain maindata) {
