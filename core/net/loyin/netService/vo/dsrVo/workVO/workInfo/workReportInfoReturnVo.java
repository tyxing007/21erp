...
public class workReportInfoReturnVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private workReportInfoReturnDataMain maindata;
    ...
    @Override
    public workReportInfoReturnDataMain getMaindata() {
        return maindata;
    }

    public void setMaindata(workReportInfoReturnDataMain maindata) {
