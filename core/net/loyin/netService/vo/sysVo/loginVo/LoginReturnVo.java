...
public class LoginReturnVo extends CommonMessageVO {

    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private LoginReturnMainData maindata;
...
//        }
    ...
    @Override
    public LoginReturnMainData getMaindata() {
        return maindata;
    }

    public void setMaindata(LoginReturnMainData maindata) {
