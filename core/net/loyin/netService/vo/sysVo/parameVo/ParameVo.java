...
public class ParameVo extends CommonMessageVO {


    @XmlElement(name = "main_message")
    @JsonProperty("main_message")
    private ParameMainData maindata;
    ...
    public String validate() {
        String msg = "";
        if(maindata.getParameType()==null || maindata.getParameType().isEmpty()){
            msg ="缺少类型,请核对";
        }
        return msg;
    }
    ...
    @Override
    public ParameMainData getMaindata() {
        return maindata;
    }

    public void setMaindata(ParameMainData maindata) {
