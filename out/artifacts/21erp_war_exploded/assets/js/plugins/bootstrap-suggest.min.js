...
!function (a) {
    ...
    var b = {
        init: function (b) {
            function c(a, b, c) {
                "left" === c.listAlign ? b.css({
                    left: a.siblings("div").width() - a.parent().width(),
                    right: "auto"
                }) : "right" === c.listAlign && b.css({left: "auto", right: "0"})
            }
            ...
            function m(a, b, c) {
                var d, e, f, g, h, j, l, m = a.parent().find("ul.dropdown-menu"), o = 0, p = ['<table class="table table-condensed">'];
            ...
            if (a.isFunction(s.processData) && (i = s.processData), a.isFunction(s.getData) && (h = s.getData), !b.showHeader && s.effectiveFields && s.effectiveFields.length > 1 && (s.showHeader = !0), "firstByUrl" === s.getDataMethod && s.url) {
            ...
            return a("head:eq(0)").append("<style>." + s.listHoverCSS + "{" + s.listHoverStyle + "}</style>"), r.each(function () {
                ...
                return g(this) === !1 ? void console.warn("不是一个标准的 bootstrap 下拉式菜单:", this) : (s.showBtn || i.css("border-radius", "4px").parents(".input-group:eq(0)").css("width", "100%").find(".input-group-btn>.btn").hide(), i.removeClass("disabled").attr("disabled", !1).attr("autocomplete", "off"), j.css(s.listStyle), s.inputBgColor || (s.inputBgColor = i.css("background-color")), s.autoMinWidth === !1 ? j.css({"min-width": i.parent().width()}) : j.css("width", "auto"), i.on("keydown", function (b) {
                    ...
                    j.css("display", ""), -1 === s.indexId && !s.idField || s.multiWord
                }).on("click", function () {
                    var b, c = a(this).val();
