...
var model = avalon.define({$id:'view',
	...
	qry:function(type){
		...
		if(type==4){
			...
			model.query.qryType=5;//查看自己的回收站信息
	...
	operate:function(e, t) {
			if ("add" == e)
				var i = "新增"+order_type[type], r = {oper:e,orderType:type};
			else
				var i = "修改"+order_type[type], r = {oper:e,id:t,orderType:type};
			$.dialog({title:i,content:"url:"+url+"/edit.html",contentOverflowY:'scroll',
	...
	trash:function(e) {
		...
		$.dialog.confirm("您确定要放入回收站？", function() {
