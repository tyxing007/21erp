var queryConditions = {},url=rootPath+"/sso/snCreater",gridQryUrl=url+"/list.json",companyList = SYSTEM.companyList;

var model=avalon.define({
	$id:'ctrl',
	data:{companyId:SYSTEM.company.id},
	companyList : companyList,
	showMenu: function (code) {
		return SYSTEM.rights[code] == true;
	},
	reload:function(){
		THISPAGE.reloadData({companyId:model.data.companyId});
	}
});
 ...
 THISPAGE = {
	...
	view:function(id){
		$.dialog({
			...
			data : {id:id,companyId:model.data.companyId}
		});
	},
	loadGrid : function() {
		function t(t, e, i) {
...
var handle = {
		operate : function(e, t) {
			if ("add" == e)
				var i = "新增序号规则", r = {oper : e,callback : this.callback,companyId:model.data.companyId};
			else
				var i = "修改序号规则", r = {oper : e,rowId : t,callback : this.callback,companyId:model.data.companyId};
			$.dialog({
				title : i,
