...
function postData(){
	...
	//model.data.customer_id=e.id;
	//model.data.customer_name=e.name;
	if(model.data.customer_id == '' || model.data.customer_id == undefined || model.data.customer_id == 'undefined'){
	...
	if(model.data.customer_name == '' || model.data.customer_name == undefined || model.data.customer_name == 'undefined'){
		parent.parent.Public.tips({
			content : "请选择有效客户"
		});
		return;
	...
	if(model.data.contacts_id == '' || model.data.contacts_id == undefined || model.data.contacts_id == 'undefined'){
		parent.parent.Public.tips({
			content : "请选择有效联系人"
		});
		return;
	...
	if(model.data.contacts_name == '' || model.data.contacts_name == undefined || model.data.contacts_name == 'undefined'){
		parent.parent.Public.tips({
			content : "请选择有效联系人"
		});
		return;
