var api = frameElement.api, oper = api.data.oper, id = api.data.id, custParame = SYSTEM.custParame, typeList = custParame.typeList, type = api.data.type,
    s = ["", "", "通过", "拒绝"],
...
var model = avalon.define({
    $id: 'ctrl', parameList: typeList, type: type, audit_hidden: audit_hidden,
    data: {
        id: "",
        name: '',
        is_deleted: 0,
