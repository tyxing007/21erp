...
public class ConcatRecord extends Model<ConcatRecord> {
     ...
     * @return
     */
    public List<ConcatRecord> getList(Map<String, Object> parameter) {
      /*sql查询语句参数条件*/
        List<Object> parame = new ArrayList<Object>();

        String create_id = (String) parameter.get("create_id");
        String retail_id = (String) parameter.get("retail_id");
     ...
     * @return
     */
    public List<ConcatRecord> getSerchList(Map<String, Object> parameter) {
      /*sql查询语句参数条件*/
        List<Object> parame = new ArrayList<Object>();
        ...
        if (create_id != null) {
            ...
            sql.append(" and creater_id = '" + create_id + "' ");
        ...
        if (keyWord != null) {
            ...
            sql.append(" and subject like '%" + keyWord + "%' ");
