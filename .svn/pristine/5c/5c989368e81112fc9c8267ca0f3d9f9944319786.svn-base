var queryConditions = {
	...
	companyList = SYSTEM.companyList,
	companyId="",
	haveCompany,tree;
 THISPAGE = {
	init : function() {
...
viewdUser:function(id){
	$.dialog({
		...
		data : {id:id,companyId:model.query.companyId}
	});
},
	loadGrid : function() {
		function t(t, e, i) {
...
var model = avalon.define({
	...
	reload:function(){
		...
		/**岗位combo START*/
		var r = $("#position");
		var i=Public.comboTree(r,{width:260,url:rootPath+'/sso/position/tree.json',postData:{companyId: model.query.companyId},
			callback : {
				beforeClick : function(e, t) {
					if(t.type==1){
						r.val(t.name);r.data("pid", t.id);
...
var handle = {
		operate : function(e, t) {
			if ("add" == e)
				var i = "新增用户", r = {oper : e,callback : this.callback,companyId:companyId};
			else
				var i = "修改用户", r = {oper : e,rowId : t,callback : this.callback,companyId:companyId};
			$.dialog({
				title : i,
