!function ($) {
    ...
    window.liger = $.ligerui = {
        ...
        remove: function (e) {
            if ("string" == typeof e || "number" == typeof e)delete liger.managers[e]; else if ("object" == typeof e)if (e instanceof liger.core.Component)delete liger.managers[e.id]; else {
        ...
        get: function (e, t) {
            ...
            if ("object" == typeof e) {
                var i = e.length ? e[0] : e, r = i[t] || $(i).attr(t);
        ...
        run: function (e, t, i) {
            if (e) {
                ...
                if (null == this || this == window || i.isStatic) {
                    liger.plugins[e] || (liger.plugins[e] = {fn: $[liger.pluginPrev + e], isStatic: !0});
                    return new $.ligerui[i.controlNamespace][e]($.extend({}, $[i.defaultsNamespace][e] || {}, $[i.defaultsNamespace][e + "String"] || {}, t.length > 0 ? t[0] : {}))
                }
                liger.plugins[e] || (liger.plugins[e] = {fn: $.fn[liger.pluginPrev + e], isStatic: !1});
                ...
                this.each(function () {
                    if (this[i.idAttrName] || $(this).attr(i.idAttrName)) {
                        ...
                        var a = t.length > 0 ? t[0] : null, s = $.extend({}, $[i.defaultsNamespace][e], $[i.defaultsNamespace][e + "String"], a);
    ...
    $.extend(liger.core.Component.prototype, {
        __getType: function () {
            ...
            var t = e.toLowerCase(), i = this.events[t];
            return i && i.length ? !0 : !1
        }, trigger: function (e, t) {
            if (e) {
                var i = e.toLowerCase(), r = this.events[i];
                if (r) {
                    t = t || [];
            ...
            if ("object" != typeof e) {
                ...
                var r = e.toLowerCase(), a = this.events[r] || [];
                i = i || this;
                a.push({handler: t, context: i});
                this.events[r] = a
            ...
            if (e) {
                var i = e.toLowerCase(), r = this.events[i];
                if (r && r.length)if (t) {
                    for (var a = 0, s = r.length; s > a; a++)if (r[a].handler == t) {
                        r.splice(a, 1);
                        break
                    }
    ...
    liger.win = {
        top: !1, mask: function () {
            ...
            var e = this;
            e.taskbar.animate({bottom: -32}, function () {
                e.taskbar.remove();
                e.taskbar = null
            })
            ...
            var i = e.get("title"), r = t.tasks[e.id] = $('<div class="l-taskbar-task"><div class="l-taskbar-task-icon"></div><div class="l-taskbar-task-content">' + i + "</div></div>");
    ...
    liger.draggable = {dragging: !1};
    liger.resizable = {reszing: !1};
    liger.toJSON = "object" == typeof JSON && JSON.stringify ? JSON.stringify : function (e) {
        var t = function (e) {
            return 10 > e ? "0" + e : e
        }, i = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, r = function (e) {
            i.lastIndex = 0;
...
!function (e) {
    ...
    e.ligerui.controls.Tab.ligerExtend(e.ligerui.core.UIComponent, {
        __getType: function () {
            ...
            var r = e("> div[lselected=true]", t.tab.content), a = r.length > 0;
            t.selectedTabId = r.attr("tabid");
            e("> div", t.tab.content).each(function (i) {
                var r = e('<li class=""><a></a><div class="l-tab-links-item-left"></div><div class="l-tab-links-item-right"></div></li>'), s = e(this);
                if (s.attr("title")) {
            ...
            t.tab.bind("dblclick.tab", function (r) {
                if (i.dblClickToClose) {
                    t.dblclicking = !0;
                    var a = r.target || r.srcElement, s = a.tagName.toLowerCase();
                    if ("a" == s) {
                        var o = e(a).parent().attr("tabid"), n = e(a).parent().find("div.l-tab-links-item-close").length ? !0 : !1;
                        n && t.removeTabItem(o)
                    }
                    t.dblclicking = !1
                }
            ...
            var r = e(t).ligerDrag({
                revert: !0, animate: !1, proxy: function () {
                    ...
                    var a = i.tab.links.ul.find(">li"), s = a.index(t.target);
                    a.each(function (t) {
                        if (s != t) {
                            var a = t > s;
                            if (-1 == i.dropIn || i.dropIn == t) {
                                var o = e(this).offset(), n = {
                                    top: o.top,
                                ...
                                var l = r.pageX || r.screenX, d = r.pageY || r.screenY;
                                if (l > n.left && l < n.right && d > n.top && d < n.bottom) {
                                    i.droptip.css({left: n.left + 5, top: n.top - 9}).show();
                                    i.dropIn = t;
                    ...
                    if (i.dropIn > -1) {
                        var r = i.tab.links.ul.find(">li:eq(" + i.dropIn + ")").attr("tabid"), a = e(t.target).attr("tabid");
                        setTimeout(function () {
                            i.moveTabItem(a, r)
                        }, 0);
                        i.dropIn = -1;
            ...
            var i = this, r = i.tab.links.ul.find(">li[tabid=" + e + "]"), a = i.tab.links.ul.find(">li[tabid=" + t + "]"), s = i.tab.links.ul.find(">li").index(r), o = i.tab.links.ul.find(">li").index(a);
                ...
                if (0 === e(".l-tab-menu").length) {
                    ...
                    e(".l-tab-menu p").each(function () {
                        e(this).click(function () {
                            t._menuItemClick({id: e(this).data("opt")});
                            e(".l-tab-menu").hide()
                        })
                    })
            ...
            var t = this, i = (this.options, e(".l-tab-links-left", t.tab.links).width()), r = new Array;
            ...
            for (var a = -1 * parseInt(t.tab.links.ul.css("left")), s = 0; s < r.length - 1; s++)if (r[s] < a && r[s + 1] >= a) {
                t.tab.links.ul.animate({left: -1 * parseInt(r[s])});
                return
            }
        }, moveToNextTabItem: function () {
            var t = this, i = (this.options, e(".l-tab-links-right", t.tab).width()), r = 0, a = e("li", t.tab.links.ul);
            a.each(function () {
                r += e(this).width() + 2
            });
            ...
            for (var d = -1 * parseInt(t.tab.links.ul.css("left")), c = 1; c < o.length; c++)if (o[c] <= d && o[c - 1] > d) {
                t.tab.links.ul.animate({left: -1 * parseInt(o[c - 1])});
                return
            }
            ...
            var s = i.url, o = i.content, n = (i.target, i.text), l = i.showClose, d = i.height, c = e("li[tabid=" + t + "]", r.tab.links.ul), u = e(".l-tab-content-item[tabid=" + t + "]", r.tab.content), p = e("div:first", u).show();
            if (c && u) {
                c.attr("tabid", a);
                u.attr("tabid", a);
            ...
            if (i > r) {
                ...
                t.tab.links.ul.animate({left: -1 * (i - r + a + 2)})
            }
            ...
            var s = t.url, o = t.content, n = t.text, l = t.showClose, d = t.height;
            if (i.isTabItemExist(a)) {
                ...
                var u = e("<li><a></a><div class='l-tab-links-item-left'></div><div class='l-tab-links-item-right'></div><div class='l-tab-links-item-close'></div></li>"), p = e("<div class='l-tab-content-item'><div class='l-tab-loading' style='display:block;'></div><iframe frameborder='0'></iframe></div>"), h = e("div:first", p), f = e("iframe:first", p);
                if (i.makeFullHeight) {
            ...
            var s = e(".l-tab-content-item[tabid=" + t + "]", i.tab.content), o = e("iframe", s);
            if (o.length) {
                var n = o[0];
                n.src = "about:blank";
                try {
            ...
            var t = this, i = (this.options, t.tab.height() + e);
            t.setHeight(i)
            ...
            var t = this, i = (this.options, t.tab.height() - t.tab.links.height());
            ...
            var i = this, r = (this.options, i.getTabidList(t, !0));
            e(r).each(function () {
                i.removeTabItem(this)
            })
        }, reload: function (t) {
            var i = (this.options, e(".l-tab-content-item[tabid=" + t + "]")), r = e(".l-tab-loading:first", i), a = e("iframe:first", i), s = e(a).attr("src");
            r.show();
            a.attr("src", s).unbind("load.tab").bind("load.tab", function () {
                r.hide()
            })
        }, removeAll: function () {
            var t = this, i = (this.options, t.getTabidList(null, !0));
            e(i).each(function () {
            ...
            t.bind("contextmenu", function (r) {
                if (i.tab.menu) {
                    ...
                    i.tab.menu.show({top: r.pageY, left: r.pageX});
...
!function (e) {
    ...
    e.ligerDefaults.Menu = {width: 120, top: 0, left: 0, items: null, shadow: !0};
    e.ligerMethos.Menu = {};
    ...
    e.ligerui.controls.Menu.ligerExtend(e.ligerui.core.UIComponent, {
        __getType: function () {
            ...
            t.menu = t.createMenu();
            t.element = t.menu[0];
            t.menu.css({top: i.top, left: i.left, width: i.width});
            ...
            void 0 == t && (t = i.menu);
            e && void 0 != e.left && t.css({left: e.left});
            e && void 0 != e.top && t.css({top: e.top});
            t.show();
            i.updateShadow(t)
        }, updateShadow: function (e) {
            var t = this.options;
            if (t.shadow) {
                e.shadow.css({left: e.css("left"), top: e.css("top"), width: e.outerWidth(), height: e.outerHeight()});
            ...
            if (t) {
                void 0 == i && (i = r.menu);
                if (t.line)i.items.append('<div class="l-menu-item-line"></div>'); else {
                    var s = e('<div class="l-menu-item"><div class="l-menu-item-text"></div> </div>'), n = e("> .l-menu-item", i.items).length;
                    i.items.append(s);
                    ...
                    s.hover(function () {
                        if (!e(this).hasClass("l-menu-item-disable")) {
                            var a = e(this).offset().top, s = a - i.offset().top;
                            l.css({top: s});
                            r.hideAllSubMenu(i);
                            if (t.children) {
                                ...
                                if (!n)return;
                                if (r.menus[n]) {
                                    r.show({top: a, left: e(this).offset().left + e(this).width() - 5}, r.menus[n]);
                                    i.showedSubMenu = !0
                                }
                            }
                        }
            ...
            var i = this, r = this.options, a = e('<div class="l-menu" style="display:none"><div class="l-menu-yline"></div><div class="l-menu-over"><div class="l-menu-over-l"></div> <div class="l-menu-over-r"></div></div><div class="l-menu-inner"></div></div>');
            ...
            a.hover(null, function () {
                a.showedSubMenu || e("> .l-menu-over:first", a).css({top: -24})
            });
